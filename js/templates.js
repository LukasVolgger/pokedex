...
function generatePokemonDetailsCardHTML(array, i) {
    return `
        ...
        <button class="nav-btn nav-btn-left btn" onclick="nextPokemonLeft(${getArrayNameAsString(array)}, ${i})"><img src="./assets/img/icons/arrow_left.svg" alt="Arrow Left" title="Left!"></button>
            ...
            <button class="nav-btn nav-btn-right btn" onclick="nextPokemonRight(${getArrayNameAsString(array)}, ${i})"><img src="./assets/img/icons/arrow_right.svg" alt="Arrow Right" title="Right!"></button>
        </div>
    `;
}
